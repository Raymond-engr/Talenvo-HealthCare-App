...
interface ExploreSearchTabsProps {
  onAdvancedFiltersClick: () => void
}

function ExploreSearchTabs({ onAdvancedFiltersClick }: ExploreSearchTabsProps) {
  return (
    ...
    <div className="relative flex-1">
      ...
      />
        ...
        <div>
          <Button className="text-gray-900 border bg-white hover:bg-gray-50 px-3 py-2" onClick={onAdvancedFiltersClick} >
